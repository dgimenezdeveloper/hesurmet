        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-xs font-semibold text-emerald-500 uppercase tracking-widest mt-1">Gestión Ambiental</p>
            </div>
            <p className="text-slate-400 leading-relaxed text-sm">
              Líderes en higiene urbana y saneamiento desde 2004. Transformamos la gestión de residuos con tecnología y compromiso ecológico en Almirante Brown.
            </p>
            <div className="flex space-x-3 pt-2">
              <SocialButton icon={FaFacebookF} href="https://facebook.com/hesurmet" />
              <SocialButton icon={FaInstagram} href="https://instagram.com/hesurmet" />
              <SocialButton icon={FaLinkedinIn} href="https://linkedin.com/company/hesurmet" />
              <SocialButton icon={BsWhatsapp} href="https://wa.me/1122651969" active />
            </div>
          </div>

          {/* Column 2: Quick Links */}
          <div>
            <h4 className="font-heading text-white font-semibold text-lg mb-6">Enlaces Rápidos</h4>
