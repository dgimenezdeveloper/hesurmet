      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            ...
            style={{ filter: 'brightness(1.0) contrast(1.1) drop-shadow(0 0 16px #10b981)' }}
          />
          <div className="absolute inset-0 bg-slate-900/80 bg-gradient-to-r from-slate-950/90 via-slate-900/80 to-transparent"></div>
        </div>
          ...
          <div className="md:w-3/4 lg:w-2/3">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a href="#contacto" className="w-full sm:w-auto">
                 <Button variant="outline" size="lg" className="w-full h-14 px-8 text-base text-white border-slate-500 bg-white/5 backdrop-blur-sm hover:bg-white hover:text-slate-900 rounded-xl">
